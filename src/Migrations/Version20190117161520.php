 ...
 */
final class Version20190117161520 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, editeur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, annee_production DATE DEFAULT NULL, note NUMERIC(10, 0) DEFAULT NULL, synopsis LONGTEXT DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, bande_annonce VARCHAR(255) DEFAULT NULL, INDEX IDX_8244BE223375BD21 (editeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
